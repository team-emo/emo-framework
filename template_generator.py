...
<!-- FILE AUTOGENERATED BY template_generator.py DO NOT EDIT -->
<plist version="1.0">
<dict>
	<key>Description</key>
...
class Xcode4Template(object):
    def __init__( self, directory, group=0, identifier="XXX" ):
        ...
        self.group_start_index = group  # eg: if 1 then Emo-iOS/libs/something -> ["libs", "something"] ignoring "Emo-iOS"
        self.output = []
...
def help():
    ...
    print "\t-g directory_used_as_starting_group (if 1, then 'Emo-iOS/libs/something' -> ['libs','something'] ignoring 'Emo-iOS')"
    print "\t-i identifier (Xcode4 template identifier)"
    print "\nExample:"
    print "\t%s -d Emo-iOS/libs/something -g 1 -i com.emo_framework.libsomething" % sys.argv[0]
    sys.exit(-1)
